...
const translations = {
  en: {
    ...
    heroBadge: "Uzbekistan's #1 NFC Card",
    heroTitle: 'One tap.<br/><em>Everything shared.</em>',
    heroSub: 'Your contacts, links, or portfolio — shared instantly with a single tap. No app. No friction.',
    heroStats: '⚡ Ships in 3 days · 📱 No app needed · ✏️ Edit anytime',
    orderNow: '⚡ Order Now', exploreCards: 'See Pricing',
    howLabel: 'How It Works', howTitle: 'Simple as 1 — 2 — 3.',
    howSub: 'From order to tap — the whole process takes minutes, not days.',
    howStep1Title: 'Order your card', howStep1Desc: 'Pick a plan and color. Ships pre-programmed in 3 days — open the box and it works.',
    howStep2Title: 'Add your info', howStep2Desc: 'Phone, socials, website — add what matters. Edit anytime from any browser, no login hassle.',
    howStep3Title: 'Tap & share', howStep3Desc: 'Hold near any phone. Profile opens instantly. They tap to save your contact — done.',
    ...
    pickPlan: 'No hidden fees. Every card ships ready to tap.',
    pricingTrust: '🔒 Secure payment · 🚚 Ships in 3 days · ✅ Quality guaranteed',
    starter: 'Starter', starterDesc: 'Try NFC for the first time or everyday personal use.',
    orderStarter: 'Order Starter',
    pro: 'Pro', proDesc: 'All colors. More fields. Looks polished and professional.',
    orderPro: 'Order Pro',
    premiumTitle: 'Premium', premiumDesc: 'Maximum fields. Every color. Built for active networkers.',
    ...
    regionLabel: 'Region', selectRegion: '— Select region —',
    ...
    b2bFilterAll: 'All',
    catSupermarket:'Supermarket', catElektronika:'Electronics', catDorixona:'Pharmacy', catRestoran:'Restaurant', catSalon:'Salon',
    slAnora:'Supermarket · White', slNexmart:'Supermarket · Black',
    slTechno:'Electronics · Neon', slSmart:'Electronics · Premium Black',
    slHealth:'Pharmacy · Green', slMedplus:'Pharmacy · White/Green',
  ...
  uz: {
    ...
    heroBadge: "O'zbekistondagi #1 NFC Karta",
    heroTitle: 'Bir teginish.<br/><em>Hammasi ulashildi.</em>',
    heroSub: 'Kontakt, havolalar yoki portfoliongiz — bir teginishda darhol ulashiladi. App kerak emas.',
    heroStats: '⚡ 3 kunda yetkazish · 📱 App kerak emas · ✏️ Istalgan vaqt o\'zgartirish',
    orderNow: '⚡ Buyurtma Berish', exploreCards: 'Narxlarni Ko\'rish',
    howLabel: 'Qanday Ishlaydi', howTitle: 'Oddiy — 1, 2, 3.',
    howSub: 'Buyurtmadan teginishgacha — hamma narsa daqiqalar ichida.',
    howStep1Title: 'Kartangizni buyurtma bering', howStep1Desc: 'Reja va rang tanlang. 3 kunda tayyor holda yetkaziladi — qutiidan chiqarib darhol ishlaydi.',
    howStep2Title: 'Ma\'lumotlaringizni kiriting', howStep2Desc: 'Telefon, ijtimoiy tarmoq, sayt — muhim narsalarni qo\'shing. Istalgan qurilmadan tahrirlang.',
    howStep3Title: 'Teging va ulashing', howStep3Desc: 'Istalgan telefonga yaqinlashtiring. Profil darhol ochiladi. Kontakt saqlanadi — tamom.',
    ...
    pickPlan: 'Yashirin to\'lovlar yo\'q. Har bir karta teginishga tayyor holda yetkaziladi.',
    pricingTrust: '🔒 Xavfsiz to\'lov · 🚚 3 kunda yetkazish · ✅ Sifat kafolati',
    starter: 'Starter', starterDesc: 'NFC ni sinab ko\'rish yoki kundalik shaxsiy foydalanish uchun.',
    orderStarter: 'Starter Buyurtma',
    pro: 'Pro', proDesc: 'Barcha ranglar. Ko\'proq maydon. Professional taassurot.',
    orderPro: 'Pro Buyurtma',
    premiumTitle: 'Premium', premiumDesc: 'Maksimal maydon. Hamma rang. Faol tarmoq qurishga ideal.',
    ...
    regionLabel: 'Viloyat', selectRegion: '— Viloyatni tanlang —',
    ...
    catSupermarket:'Supermarket', catElektronika:'Elektronika', catDorixona:'Dorixona', catRestoran:'Restoran', catSalon:'Salon',
    slAnora:'Supermarket · Oq', slNexmart:'Supermarket · Qora',
    slTechno:'Elektronika · Neon', slSmart:'Elektronika · Premium qora',
    slHealth:'Dorixona · Yashil', slMedplus:'Dorixona · Oq/Yashil',
  ...
  ru: {
    ...
    heroBadge: '#1 NFC Карта в Узбекистане',
    heroTitle: 'Одно касание.<br/><em>Всё передано.</em>',
    heroSub: 'Контакты, ссылки или портфолио — мгновенно одним касанием. Без приложений. Без лишнего.',
    heroStats: '⚡ Доставка за 3 дня · 📱 Без приложений · ✏️ Редактируй в любое время',
    orderNow: '⚡ Заказать', exploreCards: 'Смотреть цены',
    howLabel: 'Как это работает', howTitle: 'Просто — 1, 2, 3.',
    howSub: 'От заказа до первого касания — всё занимает минуты.',
    howStep1Title: 'Закажите карту', howStep1Desc: 'Выберите тариф и цвет. Доставка 3 дня — достаньте из коробки, сразу работает.',
    howStep2Title: 'Добавьте данные', howStep2Desc: 'Телефон, соцсети, сайт — редактируйте с любого устройства в любое время.',
    howStep3Title: 'Прикоснитесь и поделитесь', howStep3Desc: 'Поднесите к любому телефону. Профиль открылся. Контакт сохранён — готово.',
    ...
    pickPlan: 'Никаких скрытых платежей. Каждая карта готова к использованию.',
    pricingTrust: '🔒 Безопасная оплата · 🚚 Доставка за 3 дня · ✅ Гарантия качества',
    starter: 'Starter', starterDesc: 'Попробуйте NFC или используйте для личных нужд.',
    orderStarter: 'Заказать Starter',
    pro: 'Pro', proDesc: 'Все цвета. Больше полей. Профессиональный вид.',
    orderPro: 'Заказать Pro',
    premiumTitle: 'Premium', premiumDesc: 'Максимум полей. Все цвета. Для активного нетворкинга.',
    ...
    regionLabel: 'Регион', selectRegion: '— Выберите регион —',
    ...
    b2bFilterAll: 'Все',
    catSupermarket:'Супермаркет', catElektronika:'Электроника', catDorixona:'Аптека', catRestoran:'Ресторан', catSalon:'Салон',
    slAnora:'Супермаркет · Белый', slNexmart:'Супермаркет · Чёрный',
    slTechno:'Электроника · Неон', slSmart:'Электроника · Премиум чёрный',
    slHealth:'Аптека · Зелёный', slMedplus:'Аптека · Белый/Зелёный',
...
async function placeStickerOrder() {
  ...
  if (!phone) {
    showToast('Telefon raqam kiritilishi shart.', 'warning');
    return;
  }

  // Business name will be entered in NFC info form; use design name as placeholder for order record
  let bizName = '—';
  if (_dsDesignData?.preview) bizName = 'Canvas dizayn';
  else if (_selectedCatalogDesign) bizName = _selectedCatalogDesign.name;
  ...
  try {
    ...
    _selectedCatalogDesign = null;
    stResetDesign();
    const stPhoneEl = document.getElementById('stPhone'); if(stPhoneEl) stPhoneEl.value='';
...
function addSiField(preType, preValue) {
  ...
  if (count >= SI_MAX) { showToast(`Maksimal ${SI_MAX} ta ma'lumot`, 'warning'); return; }
  const idx = _siUidCounter++;
  const initType = preType || STICKER_FIELD_TYPES[0].type;
  const initFt   = STICKER_FIELD_TYPES.find(f => f.type === initType) || STICKER_FIELD_TYPES[0];
  const optsHtml = STICKER_FIELD_TYPES.map(f =>
    `<option value="${f.type}"${f.type === initType ? ' selected' : ''}>${f.icon} ${f.type}</option>`
  ).join('');
...
function updateSiPreview() {
  ...
  for (const el of (document.getElementById('siFieldsList')?.children || [])) {
    ...
    if (!val) continue;
    if (ft.type === 'Biznes nomi') { bizName = val; continue; }
    rows.push({ icon: ft.icon, label: ft.type, val });
  }
...
function openStickerInfoForm() {
  ...
  if (list) list.innerHTML = '';
  _siUidCounter = 0;
  // Auto-add phone field pre-filled from order
  if (_lastStickerOrderData?.phone) {
    addSiField('Telefon', _lastStickerOrderData.phone);
  }
  updateSiCount();
  updateSiPreview();
...
async function submitStickerInfo() {
  // Collect all values from dynamic fields
  let bizName = '', phone = '', address = '', hours = '', desc = '';
  const extras = [];
  for (const el of (document.getElementById('siFieldsList')?.children || [])) {
    const idx  = el.id.replace('si-field-', '');
    const sel  = document.getElementById(`si-select-${idx}`);
    ...
    const val  = inp?.value?.trim() || '';
    if (!val) continue;
    if      (type === 'Biznes nomi') bizName = val;
    else if (type === 'Telefon')     phone   = val;
    else if (type === 'Manzil')      address = val;
